                        ...
                        <div class="nonloop-block-3 no-direction owl-carousel">
                            ...
                            <div class="testimony">
                                <blockquote>
                                    ...
                                    <p>&ldquo;PHARMA service during COVID 19 is magnificent. It gives good discounts
                                        than
                                        medical shops. The Website is very simple to choose and the service is very much
                                        proficient and prompt. Pretty satisfied with the service. Good Part is you need
                                        not
                                        spend huge bucks on Doctor's prescribed medical shops which is other big relief.
                                        Way
                                        to GO.&rdquo;</p>
                                </blockquote>
                            ...
                            <div class="testimony">
                                <blockquote>
                                    <img src="images/person_2.jpg" alt="Image"
                                        class="img-fluid w-25 mb-4 rounded-circle">
                                    <p>&ldquo;As an NRI for me personally PHARMA offers a great relief in getting
                                        medicines
                                        for my family from finger tip without any hazzles all the time with very limited
                                        lead
                                        time on all orders. very happy to be a customer and surely recommend it to all
                                        those
                            ...
                            <div class="testimony">
                                <blockquote>
                                    <img src="images/person_3.jpg" alt="Image"
                                        class="img-fluid w-25 mb-4 rounded-circle">
                                    <p>&ldquo;Now I became customer of pharma.com. Every time I ordering the medicine on
                                        pharma.com
                                        . It is very helpful website in online shopping for healthcare products. Its
                                        delivering service is
                                        very fast, and packing also very good, if by mistake any medicine is wrong
                                        deliver then easily
                            ...
                            <div class="testimony">
                                <blockquote>
                                    <img src="images/person_4.jpg" alt="Image"
                                        class="img-fluid w-25 mb-4 rounded-circle">
                                    <p>&ldquo;I would like to thanks Pharma for their brilliant Customer Service. I
                                        ordered
                                        medicines from Pharma and they delivered my medicines within 3 days. Keep it up
                                        the
